...
// YogoGorm 代表yogo框架的orm实现
type YogoGorm struct {
...
// NewYogoGorm 代表实例化Gorm
func NewYogoGorm(params ...interface{}) (interface{}, error) {
...
// GetDB 获取DB实例
func (app *YogoGorm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
