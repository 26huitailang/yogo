...
func NewYogoTraceService(params ...interface{}) (interface{}, error) {
	c := params[0].(framework.Container)
	idService := c.MustMake(contract.IDKey).(contract.IDService)
	return &YogoTraceService{idService: idService}, nil
}

// WithTrace register new trace to context
func (t *YogoTraceService) WithTrace(c context.Context, trace *contract.TraceContext) context.Context {
...
func (t *YogoTraceService) GetTrace(c context.Context) *contract.TraceContext {
	if ginC, ok := c.(*gin.Context); ok {
...
func (t *YogoTraceService) NewTrace() *contract.TraceContext {
...
func (t *YogoTraceService) StartSpan(tc *contract.TraceContext) *contract.TraceContext {
...
// GetTrace By Http
func (t *YogoTraceService) ExtractHTTP(req *http.Request) *contract.TraceContext {
	tc := &contract.TraceContext{}
...
// Set Trace to Http
func (t *YogoTraceService) InjectHTTP(req *http.Request, tc *contract.TraceContext) *http.Request {
...
func (t *YogoTraceService) ToMap(tc *contract.TraceContext) map[string]string {
	m := map[string]string{}
	if tc == nil {
		return m
	}
...
// func (t *YogoTraceService) SetTraceIDService(service contract.IDService) {
// 	t.traceIDGenerator = service
// }

// func (t *YogoTraceService) SetSpanIDService(service contract.IDService) {
